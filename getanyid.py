#Copyright ©️ 2022 Helpsomeone. All Rights Reserved
#You are free to use this code in any of your project, but you MUST include the following in your README.md (Copy & paste)
# ##Credits - [GETAny_ID_bot by Helpsomeone] (https://github.com/Helpsomeone/GET_ID)

from pyrogram import Client, filters
from pyrogram.types import Message
import os

GETAny_ID_bot=Client(
    "GETAny_ID_bot",
...
@GETAny_ID_bot.on_message(filters.command('start') & filters.private)
...
🏠 | [Home](https://t.me/teletipsofficialchannel)
            """
    await GETAny_ID_bot.send_message(message.chat.id, text, disable_web_page_preview=True)


@GETAny_ID_bot.on_message(filters.command('id'))
